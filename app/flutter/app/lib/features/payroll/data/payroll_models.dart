...
class PayrollPeriod {
  ...
  factory PayrollPeriod.fromJson(Map<String, dynamic> json) {
    return PayrollPeriod(
      ...
      workerCount: _toInt(json['worker_count']),
      totalGross: _toInt(json['total_gross']),
      totalFinal: _toInt(json['total_final']),
...
class PayrollCalculation {
  ...
  factory PayrollCalculation.fromJson(Map<String, dynamic> json) {
    return PayrollCalculation(
      ...
      totalBonuses: _toInt(json['total_bonuses']),
      totalDeductions: _toInt(json['total_deductions']),
      totalAdvances: _toInt(json['total_advances']),
      advanceCarryforward: _toInt(json['advance_carryforward']),
      finalPay: _toInt(json['final_pay']),
      hasAdjustments: json['has_adjustments'] as bool? ?? false,
      calculationVersion: _toInt(json['calculation_version']),
  ...
  factory PeriodDetail.fromJson(Map<String, dynamic> json) {
    return PeriodDetail(
      ...
      calculations: (json['calculations'] as List<dynamic>?)
              ...
              .toList() ??
          [],
      pendingEntriesCount: _toInt(json['pending_entries_count']),
    );
  }
